...
import {useAddMutation, useEditMutation, useDeleteMutation, useDeleteBulkMutation, useLazyParticularListQuery, useLazyListQuery} from '../../redux/api/DepartmentApi.js'

export default function Index() {
    const [pageName] = useState([{
        title_1 : 'ADD DEPARTMENT',
        title_2 : 'DELETE SELECTED DEPARTMENT',
        title_3 : "EDIT DEPARTMENT",
        title_4 : "DEPARTMENT",
        title_5 : "ADD-MANAGE DEPARTMENT'S",
    }])
    ...
    const openEditModal = async (record_id) => {   
        ...
        getParticularRecord(record_id).then((response)=>{  
            setValue("department_name", response.data.data.department_name)   
                                            ...
                                            <form method="POST" onSubmit={handleSubmit(onSubmit)} encType="multipart/form-data">
                                                ...
                                                <div className="row"> 
                                                        <div className="col-md-4 mb-3">
                                                            ...
                                                            <input className="form-control" type="text" placeholder="Department Name" {...register('department_name', { required: 'This field is required.' })}/>
                                                            {errors.department_name && <p className="text-danger error-custom-single">{errors.department_name.message}</p>}
                                                        </div>  
