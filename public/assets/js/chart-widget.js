(function ($) {
  ...
  var optionscolumnchart = {
    ...
    colors: [dunzoAdminConfig.secondary, "#51bb25", dunzoAdminConfig.primary],
    fill: {
      type: "gradient",
      gradient: {
        shade: "light",
      ...
      xaxis: [
        {
          ...
          strokeDashArray: 0,
          borderColor: dunzoAdminConfig.primary,
          label: {
            borderColor: dunzoAdminConfig.primary,
            offsetY: 20,
            style: {
              color: "#fff",
              background: dunzoAdminConfig.primary,
            },
            text: "Anno Test",
          },
        },
  ...
  var optionscandlestickchart = {
    ...
    plotOptions: {
      candlestick: {
        colors: {
          upward: dunzoAdminConfig.primary,
          downward: dunzoAdminConfig.secondary,
        },
      },
    },
    legend: {
