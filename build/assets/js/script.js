...
(function ($) {
  ...
  $(".mode").on("click", function () {
    ...
    if (!bodyModeDark) {
      ...
      localStorage.setItem("mode-dunzo", "dark-only");
      $("body").addClass("dark-only");
      $("body").removeClass("light");
    }
    if (bodyModeDark) {
      $(".mode").removeClass("active");
      localStorage.setItem("mode-dunzo", "light");
      $("body").removeClass("dark-only");
      $("body").addClass("light");
    }
  });
  $("body").addClass(
    localStorage.getItem("mode-dunzo")
      ? localStorage.getItem("mode-dunzo")
      : "light"
  );
  $(".mode").addClass(
    localStorage.getItem("mode-dunzo") === "dark-only" ? "active" : " "
  );
  // sidebar filter
